        ...
        Node $env:COMPUTERNAME {
            ...
            Script ConfigSPN {
                ...
                SetScript            = {
                    ...
                    $spnResults = Invoke-Expression 'setspn -q HTTP/PIVS0'
                    Write-Verbose -Message  "SPN results: $($spnResults)." -Verbose

					'ConfigSPN Executed' | Out-File C:\ConfigSPNExecuted.txt

                    Write-Verbose -Message "2. Setting Kerberos Constrained Delegation on ""$using:svcRunAsDomainAccount"" for AF Server ""$($using:afServer)"", PI Data Archive ""$($using:PIServer)"", and SQL Server instance ""$($using:sqlServer)""." -Verbose
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAK2gblJUlZP1Hf
# e/LWiFmHr9gRn5tT2RllFXJcCA+5QqCCDhkwggawMIIEmKADAgECAhAIrUCyYNKc
...
# AQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDv5cEWFzpqHwzOQ5TIAlJiOz6DKiDPj
# 7iI3tFMCWKKtMDIGCisGAQQBgjcCAQwxJDAioSCAHmh0dHA6Ly90ZWNoc3VwcG9y
# dC5vc2lzb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAgAK5PXGYX3ouV6/PhYTWgJj
# D9qCFNOdwS8skKfE7aFTACk8jFgUH5mMbX29yLZ0HG2ozitRM8fVxx5yPWHGZLmi
# 2m05fdY//6DcTrimzxzWCsFIPMylAoHwTTZ2FR/UnHvTl5sKwUJOlsJcdSJk9plQ
# L5BXLIdDvKpNELTZ7jqkC8b5WuaUQzvwiSMXsYNeAoYJKkqLVjwJLrr+6cr2ICgh
# WH/X+UQbyLMLmNA9VCtllVuVutvaBY2TIa9Z4goeIYf7Q28DI6RYoPA++QQseJ+X
# VAOOTz83dCMCvZx/W6PjRtSqIxRx1wmj9z/XuDVse4Pcm7PUxkdxN5JpG0Lr/8ts
# 8XhJPkVssLZjscCAN4A+s3nvr1wqUY3rRt+1dl1ED18oa5yhWZvcInhnfXZzKodJ
# 7hV+MbESHOCFbYbxYansURPxDcmqA9qVPVriRRdlcscgwRpgHlMg5qZ+DQpNqV88
# ExoDcoEI38djWCFVeRn4IhyLffJqEXUMIv76+CsSiMIt0ZMwKWDcHC/ty4dvTiZf
# rEj9OZ210576gePWeRTbFOlTnGloovDl5R/B4l96AQhCAydLqtYlksL8i2uDQQvp
# VxKL/iV2IpuzZaLbwQWwV7vtW1SzXU2WilIaOh2oiMoFSRft1nryUK278zEp7jUk
# OA2X23tcuquFDwVkSkXu46GCFz0wghc5BgorBgEEAYI3AwMBMYIXKTCCFyUGCSqG
# SIb3DQEHAqCCFxYwghcSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwdwYLKoZIhvcNAQkQ
# AQSgaARmMGQCAQEGCWCGSAGG/WwHATAxMA0GCWCGSAFlAwQCAQUABCDCos/CxWeW
# e7Ra455UrevONiuNht51nr1rsa2Le9LV3AIQBamwgUbziKi8pjg8PVIogxgPMjAy
# MjEwMjcwMTI3MDNaoIITBzCCBsAwggSooAMCAQICEAxNaXJLlPo8Kko9KQeAPVow
...
# MDEyNzAzWjArBgsqhkiG9w0BCRACDDEcMBowGDAWBBTzhyJNhjOCkjWplLy9j5bp
# /hx8czAvBgkqhkiG9w0BCQQxIgQgqKWPlmek9yifXMTNfmQflCrwONbmGmxVfuKk
# lTGnM8QwNwYLKoZIhvcNAQkQAi8xKDAmMCQwIgQgx/ThvjIoiSCr4iY6vhrE/E/m
# eBwtZNBMgHVXoCO1tvowDQYJKoZIhvcNAQEBBQAEggIAs9mk/oKB+1mtX4hnU7+1
# WemyKSzWpZPjjGgQXoJsmkNQlymnGkRVKNFiYNr05QIs8V44khf4eGv3yzy78JBG
# xkXDUGT6T35vxU9aQY/YBn/7HCAHtU//RBVMUxPDCx+0eMU92AauExykSIR3gm8N
# Qzr75gI0JkNoCTiQBSq2yrDOklSwa6FGjRO0Hhcqe61qubFkafKy7VdmzEl6M7ZH
# +bq3E8txdQhQ8GhxNU/wtlNqM6TLkshOGuFRiaQVXdaSPZzhDe6Q69t+InCEsydA
# ClaA+isG+kfxtiJSIY8O0hwjOYM4p+D7ndoi91+Uae0vUVeF8YFsSX3EMyoImXSb
# q1oV57cTD6iEMnpMy3pa2cWYiFTT7WI4rJD71lOY1FKt//FMFmLM0ONZMZh5mo0d
# BD/WUyfUC3CsHNq8pmimsuSGCABxhNjjj37z954y9SnqJ5W3ghses798Q1X2yJ82
# wSrKGfZGfBZb8t1VesjSOILd4JE7ugWXkyTlMABjNhegG5kR8WiOTV/Qy9Qt5vjg
# 1sh6EPL6um4CsuSOqdSEh4gbM2QMD9sa5jxx9PUVTQ4YGzUjA5ORWgS0Vc2QHROc
# 9NrS86zAfQiqunW9f1u8iP+peY5ePAvFSJdczaI2OYd4n77CE0wv/p6i6NV4qhiY
# nqXMn1eBnf06npSUW0cxTrI=
